    ...
    def plot(self, input_container):
        ...
        if self._config.data.data_type.lower()=="mnist":
            ...
            plot_MNIST_output(input_data=input_container.input_data, 
                ...
                n_samples=self._config.n_plot_samples, 
                out_file="{0}/{2}_reco_{1}.png".format(self._config.output_path,self.config_string,self.date_tag))
            ...
            if self._config.model.model_type=="sVAE":
        ...
        #             else:
        #                 gif_frames.append(gif_output(input_data, output_data, epoch=epoch, max_epochs=self._config.engine.n_epochs, train_loss=train_loss,test_loss=test_loss))
        #     if self._config.create_gif:
        #         gif.save(gif_frames,"{0}/runs_{1}.gif".format(self._config.output_path,configString),duration=200)
        pass
